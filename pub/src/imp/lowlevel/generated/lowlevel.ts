...
//             let return_type_s: core_builder_procedure_declaration_G_return_type_P = ["void", null]
...
//         }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//             let start_s: core_context_start_G_start_P = ["context", null]
//             return $b.context.expectVerboseGroup({
//                 "onEnd": ($c) => {
//                     $ip.out({
...
//                                                         }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//                                                             let return_type_s: core_interface_definition_G_type_P_TU_method_O_G_return_type_P = ["void", null]
...
//             let return_type_s: core_internal_procedure_specification_G_return_type_P = ["void", null]
//             return $b.context.expectVerboseGroup({
//                 "onEnd": ($c) => {
//                     $ip.out({
...
//                                                                                                 }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//                                                                                                     let return_type_s: core_internal_procedure_specification_G_parameters_P_D_G_type_P_TU_method_O_G_return_type_P = ["void", null]
...
//         }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//             let guaranteed_s: core_missing_handler_G_guaranteed_P = ["yes", null]
//             return $b.context.expectVerboseGroup({
//                 "onEnd": ($c) => {
//                     $ip.out({
...
//         }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//             let which_s: core_namespace_selection_G_which_P = ["current", null]
//             return $b.context.expectVerboseGroup({
//                 "onEnd": ($c) => {
//                     $ip.out({
...
//             let return_value_s: core_procedure_block_G_return_value_P = ["void", null]
...
//                                                                                             let return_type_s: core_root_G_namespaces_P_D_G_procedure_declarations_P_D_G_return_type_P = ["void", null]
//                                                                                             return $b.context.expectVerboseGroup({
//                                                                                                 "onEnd": ($c) => {
//                                                                                                     $ip.out({
...
//             "out": ($: core_type) => void
//         }): deserialize_api_ValueHandler_I<NonTokenAnnotation, TokenAnnotation> {
//             let occurence_s: core_type_G_occurence_P = ["required", null]
//             let type_s: core_type_G_type_P = ["string", null]
//             return $b.context.expectVerboseGroup({
//                 "onEnd": ($c) => {
//                     $ip.out({
